...
public:
	...
	int GenerateServerList(BYTE* lpMsg,int* size);
	int GenerateServerListName(BYTE* lpMsg,int* size);
	...
	int m_GameServersList;
	int m_GameServersCount;
private:
...
#define gServerList SingNull(CServerList)
