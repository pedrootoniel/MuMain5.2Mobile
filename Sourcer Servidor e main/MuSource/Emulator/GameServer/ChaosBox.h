// ChaosBox.h: interface for the CChaosBox class.
//
//////////////////////////////////////////////////////////////////////
...
enum eChaosMixNumber
{
	...
	CHAOS_MIX_ARCA_BATTLE_TROPHIES_MIX = 54,
	CHAOS_MIX_ARCA_BATTLE_REGISTER_MARK = 55,
...
public:
	...
	void ArcaBattleTrophiesMix(LPOBJ lpObj);
	void ArcaBattleRegisterMark(LPOBJ lpObj);
...
#define gChaosBox SingNull(CChaosBox)