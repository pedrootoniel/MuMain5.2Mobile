		...
		while(true)
		{
			...
			while(true)
			{
				if(section == 0)
				{
					...
					this->m_AppearanceDelay = lpReadFile->GetNumber();

					this->m_BossZoneCloseDelay = lpReadFile->GetAsNumber();

					this->m_BossZoneOpenDelay = lpReadFile->GetAsNumber();
				}
				else if(section == 1)
				{
					if(strcmp("end",lpReadFile->GetAsString()) == 0)
					...
					this->m_BossEggHalf = lpReadFile->GetNumber();

					this->m_BossEggMax = lpReadFile->GetAsNumber();
				}
				else if(section == 2)
				{
					if(strcmp("end",lpReadFile->GetAsString()) == 0)
					...
					this->m_RaklionBattleOfSelupan.SetSelupanSkillDelay(lpReadFile->GetNumber());
				}
				else if(section == 3)
				{
					if(strcmp("end",lpReadFile->GetAsString()) == 0)
					...
					this->m_RaklionBattleOfSelupan.SetPatternCondition(0,lpReadFile->GetNumber());

					this->m_RaklionBattleOfSelupan.SetPatternCondition(1,lpReadFile->GetAsNumber());

					this->m_RaklionBattleOfSelupan.SetPatternCondition(2,lpReadFile->GetAsNumber());

					this->m_RaklionBattleOfSelupan.SetPatternCondition(3,lpReadFile->GetAsNumber());

					this->m_RaklionBattleOfSelupan.SetPatternCondition(4,lpReadFile->GetAsNumber());

					this->m_RaklionBattleOfSelupan.SetPatternCondition(5,lpReadFile->GetAsNumber());
				}
				else
				{
					break;
