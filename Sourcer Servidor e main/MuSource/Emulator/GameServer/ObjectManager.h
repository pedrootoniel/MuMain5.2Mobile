...
class CObjectManager
{
	...
	SingletonInstance(CObjectManager)
public:
	...
	void CharacterLifeCheck(LPOBJ lpObj,LPOBJ lpTarget,int damage,int DamageType,int flag,int type,int skill,int ShieldDamage,bool combo);
};

#define gObjectManager SingNull(CObjectManager)