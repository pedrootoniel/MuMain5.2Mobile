...
void CServerInfo::ReadMapInfo() // OK
{
	...
	gArcaBattle->LoadAcheronMapAttr(gPath->GetFullPath("Terrain\\terrain93_CLOSE.att"),0,0);

	gArcaBattle->LoadAcheronMapAttr(gPath->GetFullPath("Terrain\\terrain93_OPEN.att"),0,1);

	gArcaBattle->LoadAcheronMapAttr(gPath->GetFullPath("Terrain\\terrain97_CLOSE.att"),1,0);

	gArcaBattle->LoadAcheronMapAttr(gPath->GetFullPath("Terrain\\terrain97_OPEN.att"),1,1);
...
void CServerInfo::ReadMonsterInfo() // OK
{
	...
	gMonsterAIElement->Load(gPath->GetFullPath("Monster\\AI\\MonsterAIElement.txt"));

	gMonsterAIElement->m_MonsterAIMovePath[MAP_CRYWOLF].Load(gPath->GetFullPath("Monster\\AI\\MonsterAIMovePath.txt"));

	gMonsterAIGroup->Load(gPath->GetFullPath("Monster\\AI\\MonsterAIGroup.txt"));

	gMonsterAIRule->Load(gPath->GetFullPath("Monster\\AI\\MonsterAIRule.txt"));

	gMonsterAIUnit->Load(gPath->GetFullPath("Monster\\AI\\MonsterAIUnit.txt"));
