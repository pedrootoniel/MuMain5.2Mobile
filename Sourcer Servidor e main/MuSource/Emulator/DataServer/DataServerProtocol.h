...
struct SDHP_ARCA_BATTLE_SYNC_RECV
{
...
struct SDHP_ARCA_BATTLE_SYNC_SEND
{
	PBMSG_HEAD header; // C1:15
	WORD MapServerGroup;
	BYTE ArcaState;
...
struct SDHP_ARCA_BATTLE_WINNER
{
	BYTE Attribute;
	char GuildName[9];
};
...
void GDGetItemSerialRecv(SDHP_GET_ITEM_SERIAL_RECV* lpMsg,int aIndex);
...
void GDAcheronGuardianSyncRecv(SDHP_ACHERON_GUARDIAN_SYNC_RECV* lpMsg);
void GDArcaBattleSyncRecv(SDHP_ARCA_BATTLE_SYNC_RECV* lpMsg);
void GDCrywolfSyncRecv(SDHP_CRYWOLF_SYNC_RECV* lpMsg);
