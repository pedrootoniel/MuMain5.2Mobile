...
void OpenItems()
{
	...
	gLoadData.AccessModel(MODEL_POTION + 55, "Data\\Item\\", "roboxgreen");
	gLoadData.AccessModel(MODEL_POTION + 56, "Data\\Item\\", "roboxred");	
	gLoadData.AccessModel(MODEL_POTION + 57, "Data\\Item\\", "roboxpurple");
