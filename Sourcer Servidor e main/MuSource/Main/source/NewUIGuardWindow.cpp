...
{
	LoadBitmap("Common\\Interface\\ui_item_backtop.jpg", IMAGE_GUARDWINDOW_TOP);
	LoadBitmap("Common\\Interface\\ui_item_backlow.jpg", IMAGE_GUARDWINDOW_LOW);

	LoadBitmap("Common\\Interface\\ui_menu_exit.jpg", IMAGE_GUARDWINDOW_EXIT_BTN);
	...
	LoadBitmap("Common\\Interface\\ui_msgbox_line.jpg", IMAGE_GUARDWINDOW_SCROLL_TOP);
...
void CNewUIGuardWindow::UnloadImages()
{
	...
	DeleteBitmap(IMAGE_GUARDWINDOW_LOW);
...
{
	RenderBitmap(IMAGE_GUARDWINDOW_TOP, m_Pos.x, m_Pos.y, 190.0, 256.0, 0, 0, 0.7421875, 1.0, 1, 1, 0.0);
	RenderBitmap(IMAGE_GUARDWINDOW_LOW, m_Pos.x, m_Pos.y + 256.0, 190.0, 177.0, 0, 0, 0.7421875, 0.69140625, 1, 1, 0.0);
