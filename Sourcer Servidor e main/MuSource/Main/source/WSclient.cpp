...
BYTE Version[SIZE_PROTOCOLVERSION] = {'1'+1, '0'+2, '4'+3, '1'+4, '0'+5};
...
void ReceiveCharacterList( BYTE *ReceiveBuffer )
{
	...
	for(int i=0;i<Data->Value;i++)
	{
		...
		switch(Data2->Index)
		{
		case 0:	fPos[0] = 12880.0f;	fPos[1] = 15046.0f;	fAngle = 100.0f; break;
		case 1:	fPos[0] = 12863.0f;	fPos[1] = 15251.0f;	fAngle = 75.0f; break;
		case 2:	fPos[0] = 12974.0f;	fPos[1] = 15425.0f;	fAngle = 50.0f; break;
		case 3:	fPos[0] = 13151.0f;	fPos[1] = 15533.0f;	fAngle = 25.0f; break;
		case 4:	fPos[0] = 13349.6f;	fPos[1] = 15527.0f;	fAngle = 0.0f; break;
		case 5:	fPos[0] = 13349.6f;	fPos[1] = 15527.0f;	fAngle = 0.0f; break;
		default: return;
		}
...
BOOL ReceiveEquipmentItem(BYTE *ReceiveBuffer, BOOL bEncrypted)
{
	...
	if(Data->SubCode != 255)
	{
		...
		if(Data->SubCode == 3 || (Data->SubCode >= 5 && Data->SubCode <= 8)	|| (Data->SubCode == 9)	|| (Data->SubCode == 10))
		{
			SEASON3B::CNewUIInventoryCtrl::DeletePickedItem();
...
void ReceiveCharacterRefresh(BYTE* ReceiveBuffer)
{
	LPPRECEIVE_CHARACTER_REFRESH Data = (LPPRECEIVE_CHARACTER_REFRESH)ReceiveBuffer;
	...
	CharacterAttribute->Shield = Data->Shield;
	CharacterAttribute->ShieldMax = Data->MaxShield;
	CharacterAttribute->AddPoint = Data->FruitAddPoint;
	CharacterAttribute->MaxAddPoint = Data->MaxFruitAddPoint;
...
void ReceiveMana( BYTE *ReceiveBuffer )
{
	...
	case 0xFE:
		...
		CharacterAttribute->SkillManaMax = Data->SkillMana;
		break;
	default:
		CharacterAttribute->Mana = Data->Mana;
...
void ReplyDuelStart(BYTE* ReceiveBuffer)
{
	...
	else
	{
		...
		strncpy(g_szDuelPlayerID, (const char*)Data->ID, MAX_ID_SIZE);
		g_szDuelPlayerID[10] = NULL;
		// 913 "%s ´ÔÀÌ °áÅõ½ÅÃ»À» °ÅºÎÇß½À´Ï´Ù."
	...
	case 0xF3:     			
		{
			...
			case 0x40:
				...
				break;
			case 0xE0:
				ReceiveCharacterRefresh(ReceiveBuffer);
				break;
			}
			break;
		}
