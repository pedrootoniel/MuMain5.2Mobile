...
{
	RenderBitmap(IMAGE_CATAPULT_TOP, m_Pos.x, m_Pos.y, 190.0, 256.0, 0, 0, 0.7421875, 1.0, 1, 1, 0.0);
	RenderBitmap(IMAGE_CATAPULT_LOW, m_Pos.x, m_Pos.y + 256.0, 190.0, 177.0, 0, 0, 0.7421875, 0.69140625, 1, 1, 0.0);
...
{
	LoadBitmap("Common\\Interface\\ui_item_backtop.jpg", IMAGE_CATAPULT_TOP);
	LoadBitmap("Common\\Interface\\ui_item_backlow.jpg", IMAGE_CATAPULT_LOW);

	LoadBitmap("Common\\Interface\\ui_menu_exit.jpg", IMAGE_CATAPULT_BTN_EXIT);

	LoadBitmap("Common\\Interface\\ui_message_box.jpg", IMAGE_CATAPULT_BTN_FIRE);
...
void SEASON3B::CNewUICatapultWindow::UnloadImages()
{
	...
	DeleteBitmap(IMAGE_CATAPULT_LOW);
}
