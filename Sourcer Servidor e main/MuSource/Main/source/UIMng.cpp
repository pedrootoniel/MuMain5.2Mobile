...
void CUIMng::CreateTitleSceneUI()
{
	...
	m_asprTitle[UIM_TS_BACK0].Create(512, 478, BITMAP_TITLE, 0, NULL, 0, 0,	false, SPR_SIZING_DATUMS_LT, fScaleX, fScaleY);
	m_asprTitle[UIM_TS_BACK0].SetPosition(0, 60);

	m_asprTitle[UIM_TS_BACK1].Create(288, 478, BITMAP_TITLE + 1, 0, NULL, 0, 0, false, SPR_SIZING_DATUMS_LT, fScaleX, fScaleY);
	m_asprTitle[UIM_TS_BACK1].SetPosition(512, 60);

	m_asprTitle[UIM_TS_MU].Create(93, 48, BITMAP_TITLE + 2, 0, NULL, 0, 0, false, SPR_SIZING_DATUMS_LT, fScaleX, fScaleY);
	m_asprTitle[UIM_TS_MU].SetPosition(3, 80);

	m_asprTitle[UIM_TS_121518].Create(256, 206, BITMAP_TITLE + 3, 0, NULL, 0, 0, false, SPR_SIZING_DATUMS_LT, fScaleX, fScaleY);
	m_asprTitle[UIM_TS_121518].SetPosition(544, 60);

	m_asprTitle[UIM_TS_WEBZEN].Create(187, 151, BITMAP_TITLE + 4, 0, NULL, 0, 0, false, SPR_SIZING_DATUMS_LT, fScaleX, fScaleY);
