...
namespace SEASON3B
{
	...
	public:	
		enum IMAGE_LIST
		{
			IMAGE_EMPIREGUARDIAN_NPC_TOP		= 0,
			IMAGE_EMPIREGUARDIAN_NPC_LEFT		= 0,
			IMAGE_EMPIREGUARDIAN_NPC_RIGHT		= 0,
			IMAGE_EMPIREGUARDIAN_NPC_BOTTOM		= 0,
			IMAGE_EMPIREGUARDIAN_NPC_BACK		= CNewUIMessageBoxMng::IMAGE_MSGBOX_BACK,
 			IMAGE_EMPIREGUARDIAN_NPC_LINE		= 0,
