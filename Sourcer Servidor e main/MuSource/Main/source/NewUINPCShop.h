...
namespace SEASON3B
{
	...
	public:
		enum IMAGE_LIST
		{
			IMAGE_NPCSHOP_TOP = CNewUIMyInventory::IMAGE_INVENTORY_BACK_TOP,
			IMAGE_NPCSHOP_LOW = CNewUIMyInventory::IMAGE_INVENTORY_BACK_LOW,
			IMAGE_NPCSHOP_BTN_REPAIR = CNewUIMyInventory::IMAGE_INVENTORY_REPAIR_BTN,
			IMAGE_NPCSHOP_BTN_REPAIR_CLICK = CNewUIMyInventory::IMAGE_INVENTORY_REPAIR_CLK,
