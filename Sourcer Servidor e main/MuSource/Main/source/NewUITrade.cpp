...
{
	RenderBitmap(IMAGE_TRADE_TOP, m_Pos.x, m_Pos.y, 190.0, 256.0, 0, 0, 0.7421875, 1.0, 1, 1, 0.0);
	RenderBitmap(IMAGE_TRADE_LOW, m_Pos.x, m_Pos.y + 256.0, 190.0, 177.0, 0, 0, 0.7421875, 0.69140625, 1, 1, 0.0);
...
{
	LoadBitmap("Common\\Interface\\ui_item_backtop.jpg", IMAGE_TRADE_TOP);
	LoadBitmap("Common\\Interface\\ui_item_backlow.jpg", IMAGE_TRADE_LOW);

	LoadBitmap("Common\\Interface\\ui_trading_line.jpg", IMAGE_TRADE_LINE);

	LoadBitmap("Interface\\newui_Account_title.tga", IMAGE_TRADE_NICK_BACK, GL_LINEAR);

	LoadBitmap("Common\\Interface\\ui_item_money.jpg", IMAGE_TRADE_MONEY);
	...
	LoadBitmap("Common\\Interface\\ui_menu_exit.jpg", IMAGE_TRADE_BTN_CLOSE);

	LoadBitmap("Common\\Interface\\ui_ware_money.jpg", IMAGE_TRADE_BTN_ZEN_INPUT);
}
