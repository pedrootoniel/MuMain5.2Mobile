...
public:
	...
	void	UpdateCount_SetOptionPerEquippedSetItem(const BYTE* byOptionList,
		int* arLimitSetItemOptionCount,
		ITEM* ItemsEquipment
	)
	{
	...
	int     RenderSetOptionListInItem(const ITEM* ip, int TextNum, bool bIsEquippedItem);
