...
namespace SEASON3B
{
	...
	public:
		enum IMAGE_LIST
		{
			...
			IMAGE_STORAGE_LOW = CNewUIMyInventory::IMAGE_INVENTORY_BACK_LOW,

			IMAGE_STORAGE_BTN_ZEN = BITMAP_INTERFACE_NEW_STORAGE_BEGIN,
			IMAGE_STORAGE_BTN_ZEN_CLICK = BITMAP_INTERFACE_NEW_STORAGE_BEGIN + 1,
