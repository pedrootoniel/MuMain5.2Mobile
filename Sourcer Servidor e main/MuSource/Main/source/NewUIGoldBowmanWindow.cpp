...
{
	RenderBitmap(IMAGE_GB_TOP, m_Pos.x, m_Pos.y, 190.0, 256.0, 0, 0, 0.7421875, 1.0, 1, 1, 0.0);
	RenderBitmap(IMAGE_GB_LOW, m_Pos.x, m_Pos.y + 256.0, 190.0, 177.0, 0, 0, 0.7421875, 0.69140625, 1, 1, 0.0);
...
{
	LoadBitmap("Common\\Interface\\ui_item_backtop.jpg", IMAGE_GB_TOP);
	LoadBitmap("Common\\Interface\\ui_item_backlow.jpg", IMAGE_GB_LOW);

	LoadBitmap("Common\\Interface\\ui_message_box.jpg", IMAGE_GB_EXCHANGEBTN);
	LoadBitmap("Common\\Interface\\ui_message_box.jpg", IMAGE_GB_BTN_SERIAL);

	LoadBitmap("Common\\Interface\\ui_menu_exit.jpg", IMAGE_GB_BTN_EXIT);

	LoadBitmap("Common\\Interface\\ui_item_money.jpg", IMAGE_GB_EDITBOX);
}
