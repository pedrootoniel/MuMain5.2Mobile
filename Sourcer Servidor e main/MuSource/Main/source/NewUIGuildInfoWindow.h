...
namespace SEASON3B
{
	...
	public:
		enum IMAGE_LIST
		{
			...
			IMAGE_GUILDINFO_LOW				= CNewUIMyInventory::IMAGE_INVENTORY_BACK_LOW,
			...
			IMAGE_GUILDINFO_SCROLL_MIDDLE	= 0, // Revisar
			IMAGE_GUILDINFO_SCROLL_BOTTOM	= 0, // Revisar
			...
			IMAGE_GUILDINFO_DRAG_BTN		= 0, // Verificar
