...
namespace SEASON3B
{
	...
	public:
		enum IMAGE_LIST
		{
			...
			IMAGE_DOPPELGANGERWINDOW_TOP = 0,	
			IMAGE_DOPPELGANGERWINDOW_LEFT = 0,
			IMAGE_DOPPELGANGERWINDOW_RIGHT = 0,
			IMAGE_DOPPELGANGERWINDOW_BOTTOM = 0,
			IMAGE_DOPPELGANGERWINDOW_BUTTON = CNewUIMessageBoxMng::IMAGE_MSGBOX_BTN_EMPTY_VERY_SMALL,
			IMAGE_DOPPELGANGERWINDOW_LINE = 0,
		};
	private:
		enum
		{
