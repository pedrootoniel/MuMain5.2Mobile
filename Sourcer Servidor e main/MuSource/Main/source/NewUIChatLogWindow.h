...
namespace SEASON3B 
{
	...
	public:
		enum IMAGE_LIST
		{
			IMAGE_SCROLL_TOP = BITMAP_INTERFACE_NEW_CHATLOGWND_BEGIN,
			IMAGE_SCROLL_NIS_RSFRAME,
			IMAGE_SCROLL_NIS_BTN_ARROW,
			IMAGE_SCROLL_NIS_VFRAME,
			IMAGE_SCROLL_NIS_BACK,
			IMAGE_SCROLL_NIS_BAR,
	...
	private:
		enum 
		{
			...
			RESIZING_BTN_WIDTH = 22, // OK
			RESIZING_BTN_HEIGHT = 12, // OK
