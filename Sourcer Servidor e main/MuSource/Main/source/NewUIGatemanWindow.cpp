...
{
	LoadBitmap("Common\\Interface\\ui_item_backtop.jpg", IMAGE_GATEMANWINDOW_TOP);
	LoadBitmap("Common\\Interface\\ui_item_backlow.jpg", IMAGE_GATEMANWINDOW_LOW);

	LoadBitmap("Common\\Interface\\ui_menu_exit.jpg", IMAGE_GATEMANWINDOW_EXIT_BTN);
...
void CNewUIGatemanWindow::UnloadImages()
{
	...
	DeleteBitmap(IMAGE_GATEMANWINDOW_LOW);
...
{
	RenderBitmap(IMAGE_GATEMANWINDOW_TOP, m_Pos.x, m_Pos.y, 190.0, 256.0, 0, 0, 0.7421875, 1.0, 1, 1, 0.0);
	RenderBitmap(IMAGE_GATEMANWINDOW_LOW, m_Pos.x, m_Pos.y + 256.0, 190.0, 177.0, 0, 0, 0.7421875, 0.69140625, 1, 1, 0.0);
