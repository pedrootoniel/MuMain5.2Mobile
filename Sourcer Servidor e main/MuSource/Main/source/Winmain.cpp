...
int APIENTRY WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, PSTR szCmdLine, int nCmdShow)
{
	...
	case 768:FontHeight = 15; break;
	case 900:FontHeight = 15; break;
	case 960:FontHeight = 15; break;
	case 1024:FontHeight = 15; break;
	case 1050:FontHeight = 16; break;
	case 1080: FontHeight = 16; break;
	case 1200: FontHeight = 17; break;
	case 1280: FontHeight = 17; break;
	case 1400: FontHeight = 18; break;
	case 1440: FontHeight = 19; break;
	}
	...
	g_hFont = CreateFont(
		iFontSize + gFontManager.m_Data[FontType::Normal].AddSize,
		0, 0, 0,
		(gFontManager.m_Data[FontType::Normal].Bold == 1 ? FW_BOLD : FW_NORMAL),
		0, 0, 0,
		gFontManager.m_Data[FontType::Normal].CharSet,
		OUT_DEFAULT_PRECIS, CLIP_DEFAULT_PRECIS,
		NONANTIALIASED_QUALITY,
		DEFAULT_PITCH | FF_DONTCARE,
		gFontManager.m_Data[FontType::Normal].Name.c_str()
	);

	g_hFontBold = CreateFont(
		iFontSize + gFontManager.m_Data[FontType::Bold].AddSize,
		0, 0, 0,
		(gFontManager.m_Data[FontType::Bold].Bold == 1 ? FW_BOLD : FW_NORMAL),
		0, 0, 0,
		gFontManager.m_Data[FontType::Bold].CharSet,
		OUT_DEFAULT_PRECIS, CLIP_DEFAULT_PRECIS,
		NONANTIALIASED_QUALITY,
		DEFAULT_PITCH | FF_DONTCARE,
		gFontManager.m_Data[FontType::Bold].Name.c_str()
	);

	g_hFontBig = CreateFont(
		(iFontSize * 2) + gFontManager.m_Data[FontType::Big].AddSize,
		0, 0, 0,
		(gFontManager.m_Data[FontType::Big].Bold == 1 ? FW_BOLD : FW_NORMAL),
		0, 0, 0,
		gFontManager.m_Data[FontType::Big].CharSet,
		OUT_DEFAULT_PRECIS, CLIP_DEFAULT_PRECIS,
		NONANTIALIASED_QUALITY,
		DEFAULT_PITCH | FF_DONTCARE,
		gFontManager.m_Data[FontType::Big].Name.c_str()
	);

	g_hFixFont = CreateFont(
		nFixFontSize + gFontManager.m_Data[FontType::Other].AddSize,
		0, 0, 0,
		(gFontManager.m_Data[FontType::Other].Bold == 1 ? FW_BOLD : FW_NORMAL),
		0, 0, 0,
		gFontManager.m_Data[FontType::Other].CharSet,
		OUT_DEFAULT_PRECIS, CLIP_DEFAULT_PRECIS,
		NONANTIALIASED_QUALITY,
		DEFAULT_PITCH | FF_DONTCARE,
		gFontManager.m_Data[FontType::Other].Name.c_str()
	);
