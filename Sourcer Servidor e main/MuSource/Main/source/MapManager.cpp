...
void CMapManager::Load() // OK
{
	...
	break;
	case WD_54CHARACTERSCENE:
		{
			LoadBitmap("Logo\\character_back01.jpg", BITMAP_LOG_IN + 9, GL_NEAREST, GL_CLAMP);
			LoadBitmap("Logo\\character_back02.jpg", BITMAP_LOG_IN + 10, GL_NEAREST, GL_CLAMP);
		}
		break;
	case WD_55LOGINSCENE:
		{
			LoadBitmap("Logo\\Login_Back01.jpg", BITMAP_LOG_IN + 9);
			LoadBitmap("Logo\\Login_Back02.jpg", BITMAP_LOG_IN + 10);
			...
			gLoadData.OpenTexture(MODEL_LOGO + 2, "Logo\\", GL_REPEAT, GL_LINEAR, true);

			Vector(10.0f, 0.0f, 36.0f, Ang);
			Vector(10680.0f, 15550.0f, 1710.0f, Pos);

			CreateObject(MODEL_LOGO + 2, Pos, Ang);
		}
		break;
	}
