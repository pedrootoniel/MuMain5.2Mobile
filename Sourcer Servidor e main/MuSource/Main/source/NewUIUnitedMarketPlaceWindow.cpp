...
{
	LoadBitmap("Common\\Interface\\ui_msgbox_back.jpg", IMAGE_UNITEDMARKETPLACEWINDOW_BACK);
	...
	LoadBitmap("Common\\Interface\\ui_trading_line.jpg", IMAGE_UNITEDMARKETPLACEWINDOW_LINE);
