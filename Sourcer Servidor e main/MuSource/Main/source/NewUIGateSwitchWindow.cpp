...
{
	LoadBitmap("Common\\Interface\\ui_item_backtop.jpg", IMAGE_GATESWITCHWINDOW_TOP);
	LoadBitmap("Common\\Interface\\ui_item_backlow.jpg", IMAGE_GATESWITCHWINDOW_LOW);

	LoadBitmap("Common\\Interface\\ui_menu_exit.jpg", IMAGE_GATESWITCHWINDOW_EXIT_BTN);

	LoadBitmap("Common\\Interface\\ui_message_box.jpg", IMAGE_GATESWITCHWINDOW_BUTTON);
}

void CNewUIGateSwitchWindow::UnloadImages()
{
	DeleteBitmap(IMAGE_GATESWITCHWINDOW_TOP);
	DeleteBitmap(IMAGE_GATESWITCHWINDOW_LOW);
...
{
	RenderBitmap(IMAGE_GATESWITCHWINDOW_TOP, m_Pos.x, m_Pos.y, 190.0, 256.0, 0, 0, 0.7421875, 1.0, 1, 1, 0.0);
	RenderBitmap(IMAGE_GATESWITCHWINDOW_LOW, m_Pos.x, m_Pos.y + 256.0, 190.0, 177.0, 0, 0, 0.7421875, 0.69140625, 1, 1, 0.0);
