...
int COMGEM::GetJewelIndex( int _nJewel, int _nType )
{
	switch( _nJewel )
	{
		...
		break;
		case eLIFE:
			if( _nType == eGEM_NAME )		return 3200;
		...
		break;
		case eCREATE:
			if( _nType == eGEM_NAME )		return 3201;
		...
		break;
		case ePROTECT:
			if( _nType == eGEM_NAME )		return 3202;
		...
		break;
		case eHARMONY:
			if( _nType == eGEM_NAME )		return 3203;
		...
		break;
		case eCHAOS:
			if( _nType == eGEM_NAME )		return 3204;
		...
		break;
		case eLOW:
			if( _nType == eGEM_NAME )		return 3205;
		...
		break;
		case eUPPER:
			if( _nType == eGEM_NAME )		return 3206;
