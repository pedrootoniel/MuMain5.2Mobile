...
{
	LoadBitmap("Common\\Interface\\ui_item_backtop.jpg", IMAGE_CASTLEWINDOW_TOP);
	LoadBitmap("Common\\Interface\\ui_item_backlow.jpg", IMAGE_CASTLEWINDOW_LOW);
	LoadBitmap("Common\\Interface\\ui_menu_exit.jpg", IMAGE_CASTLEWINDOW_EXIT_BTN);

	LoadBitmap("Interface\\newui_guild_tab04.tga", IMAGE_CASTLEWINDOW_TAB_BTN, GL_LINEAR);

	LoadBitmap("Common\\Interface\\ui_trading_line.jpg", IMAGE_CASTLEWINDOW_LINE);

	LoadBitmap("Interface\\newui_btn_empty_very_small.tga", IMAGE_CASTLEWINDOW_BUTTON, GL_LINEAR);

	LoadBitmap("Common\\Interface\\ui_item_money.jpg", IMAGE_CASTLEWINDOW_MONEY);
...
void CNewUICastleWindow::UnloadImages()
{
	...
	DeleteBitmap(IMAGE_CASTLEWINDOW_LOW);
...
{
	RenderBitmap(IMAGE_CASTLEWINDOW_TOP, m_Pos.x, m_Pos.y, 190.0, 256.0, 0, 0, 0.7421875, 1.0, 1, 1, 0.0);
	RenderBitmap(IMAGE_CASTLEWINDOW_LOW, m_Pos.x, m_Pos.y + 256.0, 190.0, 177.0, 0, 0, 0.7421875, 0.69140625, 1, 1, 0.0);
