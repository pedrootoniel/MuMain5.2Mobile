...
{
	LoadBitmap("Common\\Interface\\ui_msgbox_back.jpg", IMAGE_MSGBOX_BACK);
	LoadBitmap("Common\\Interface\\ui_msgbox_line.jpg", IMAGE_MSGBOX_LINE);

	LoadBitmap("Common\\Interface\\ui_msgbox_ok.jpg", IMAGE_MSGBOX_BTN_OK);
	LoadBitmap("Common\\Interface\\ui_msgbox_ok_click.jpg", IMAGE_MSGBOX_BTN_OK_CLICK);

	LoadBitmap("Common\\Interface\\ui_msgbox_cancel.jpg", IMAGE_MSGBOX_BTN_CANCEL);
	LoadBitmap("Common\\Interface\\ui_msgbox_cancel_click.jpg", IMAGE_MSGBOX_BTN_CANCEL_CLICK);

	LoadBitmap("Common\\Interface\\ui_message_box.jpg", IMAGE_MSGBOX_BTN_EMPTY);
	LoadBitmap("Common\\Interface\\ui_message_box.jpg", IMAGE_MSGBOX_BTN_EMPTY_SMALL);
	LoadBitmap("Common\\Interface\\ui_message_box.jpg", IMAGE_MSGBOX_BTN_EMPTY_BIG);
	LoadBitmap("Common\\Interface\\ui_message_box.jpg", IMAGE_MSGBOX_BTN_EMPTY_VERY_SMALL);
...
void SEASON3B::CNewUIMessageBoxMng::UnloadImages()
{
	...
	DeleteBitmap(IMAGE_MSGBOX_BTN_OK_CLICK);
	DeleteBitmap(IMAGE_MSGBOX_BTN_CANCEL);
	DeleteBitmap(IMAGE_MSGBOX_BTN_CANCEL_CLICK);
