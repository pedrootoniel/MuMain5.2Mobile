...
{
	SetCompleteHook(0xE8,0x0072D000,&PrintPlayerChaosRate);

	SetCompleteHook(0xE8,0x0072D12C,&PrintPlayerChaosRate);

	SetCompleteHook(0xE8,0x0072D16B,&PrintPlayerChaosRate);

	SetCompleteHook(0xE8,0x0072D1A7,&PrintPlayerChaosRate);

	SetCompleteHook(0xE8,0x0072D1E3,&PrintPlayerChaosRate);
	
	SetCompleteHook(0xE8,0x0072D2E3,&PrintPlayerChaosMoney);
	
	SetCompleteHook(0xE8,0x0072D312,&PrintPlayerChaosMoney);
}
