...
CCamera::CCamera() // OK
{
	...
	SetCompleteHook(0xE9,0x005E0741,&RotateDamageAngle);
}
...
void CCamera::Toggle() // OK
{
	...
	{
		pDrawMessage(gCustomMessage.GetMessage(1+this->m_Enable),1);
...
void CCamera::SetDefaultValue() // OK
{
	...
	pDrawMessage(gCustomMessage.GetMessage(3),1);
}
...
{
	static DWORD RotateDamageAngleAddress1 = 0x005E0660;
