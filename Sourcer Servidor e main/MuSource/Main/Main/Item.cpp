...
void InitItem() // OK
{
	...
	SetCompleteHook(0xE8,0x004E43D3,&GetItemEffect);

	SetCompleteHook(0xE8,0x005C2C77,&GetItemEffect);
...
void InitBundle() // OK
{
	SetCompleteHook(0xE9,0x00489633,&BundleCheckIndex1);

	SetCompleteHook(0xE9,0x0058759D,&BundleCheckIndex2);

	SetCompleteHook(0xE9,0x00594081,&BundleCheckIndex3);

	SetCompleteHook(0xE9,0x00593006,&BundleCheckIndex4);

	SetCompleteHook(0xE9,0x00592771,&BundleCheckIndex5);
}
...
void GetItemEffect(DWORD a,int b,float* c,float d,int e,int f,int g,int h,int i) // OK
{
	for(int n=0;n < MAX_CUSTOM_EFFECT;n++)
	{
		if(gCustomEffect.m_CustomEffectInfo[n].Index != -1)
		{
			...
			DWORD o = 244 * b + *(DWORD*)0x058E47B4; // OK
			...
			pTransformPosition(o,0x06A2C4F8+(48*gCustomEffect.m_CustomEffectInfo[n].EffectValue),Position,WorldPosition,true);
...
{
	static DWORD BundleCheckIndexAddress1 = 0x0048963F;
	static DWORD BundleCheckIndexAddress2 = 0x00489676;
...
{
	static DWORD BundleCheckIndexAddress1 = 0x005875C2;
	static DWORD BundleCheckIndexAddress2 = 0x005875B5;
...
{
	static DWORD BundleCheckIndexAddress1 = 0x0059408D;
	static DWORD BundleCheckIndexAddress2 = 0x00594208;
...
{
	static DWORD BundleCheckIndexAddress1 = 0x0059300C;
	static DWORD BundleCheckIndexAddress2 = 0x00593537;
...
{
	static DWORD BundleCheckIndexAddress1 = 0x0059277D;
	static DWORD BundleCheckIndexAddress2 = 0x005929E5;
