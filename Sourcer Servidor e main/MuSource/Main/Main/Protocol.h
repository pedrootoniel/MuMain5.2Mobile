...
struct PMSG_PC_POINT_POINT_RECV
{
...
struct PMSG_PC_POINT_PRICE_LIST_RECV
{
	PSWMSG_HEAD header;// C1:F3:E6
	BYTE count;
};

struct PMSG_PC_POINT_PRICE_RECV
{
	BYTE slot;
	DWORD money;
};
...
void GCPcPointPointRecv(PMSG_PC_POINT_POINT_RECV* lpMsg);
